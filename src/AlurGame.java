...
public class AlurGame extends Application {
    ...
    private void startGame(Stage stage) {
        try {
            ...
            snake = new Snake(WIDTH / 2, HEIGHT / 2);  // Start the snake in the middle of the arena
            spawnFood();
    ...
    private void drawGameOver(GraphicsContext gc) {
        ...
        String scoreText = "SELAMAT!!! " + username.toUpperCase() + "\n SCORE ANDA " + score;
    ...
    private void resetGame() {
        score = 0;
        snake = new Snake(WIDTH / 2, HEIGHT / 2);  // Reset snake position to the center
        spawnFood();
        gameOver = false;
        gameOverXPosition = WIDTH * TILE_SIZE;
    }
